...
import { IoChevronDown, IoCamera, IoPencil, IoClose, IoChevronBack } from 'react-icons/io5';
...
const VendorProfileSettings = () => {
  ...
  const fromVendor = location.state?.fromVendor;
